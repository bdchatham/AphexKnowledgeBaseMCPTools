 ...
 */
async function ensureScipDirectory(packagePath) {
 ...
 */
async function countSymbolsInIndex(indexPath) {
    try {
 ...
 */
export async function readScipMetadata(packagePath) {
 ...
 */
async function writeScipMetadata(packagePath, metadata) {
    const metadataPath = join(packagePath, ".archon", "scip", "metadata.json");
 ...
 */
async function invokeScipGo(packagePath, outputPath) {
 ...
 */
async function invokeScipTypeScript(packagePath, outputPath) {
 ...
 */
export async function generateScipIndex(input) {
...
//# sourceMappingURL=scip_indexing.js.map